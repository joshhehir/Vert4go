...
{    
    ...
    public class CameraZoom
    {
        ...
        //Called in CameraController. Switches _mono based on run or zoom pressed.
        ...
        //Changes the FOV when the run state changes. Starts coroutine based on current 
        //state and moves FOV to new value based on FOV curves.
