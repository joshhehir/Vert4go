    ...
    public class CameraBreathing : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            if (data != null)
            {
                ...
                {
                    //If position, based on the chosen axes, offsets those axes' position based on the noise values.
                    ...
                    //If rotation, based on the chosen axes, offsets those axes' rotation based on the noise values.
                    ...
                    //If position and rotation, based on the chosen axes, offsets those axes' position and rotation based on the noise values.
