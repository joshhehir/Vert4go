...
namespace FPSController
{
    public class HeadBob
    {
        ...
        public void ScrollHeadBob(bool _running, bool _crouching, Vector2 _input)
        {
            ...
            //Multiplier will increase or decrease when the player state switches. 
            //Running means higher, more frequent headbob. Crouching means the opposite.
            ...
            //Multipliers will decrease the headbob values depending on if they are moving backwards or sideways.
            ...
            //You can also multiply this by _additionalMultiplier but it looks unnatural a bit.
